...
/***/ function(module, exports, __webpack_require__) {
	...
	var Model = exports.Model = function () {
	    function Model() {
	        ...
	        this.game = new _Game.Game(this.matrix, this.config);
	        this.settings = new _Settings.Settings(this.matrix, this.config);
	        this.socket = new _Socket.Socket(this.matrix, this.game, this.config);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = exports.Game = function () {
	    ...
	    _createClass(Game, [{
	        ...
	        key: 'handleClick',
	        value: function handleClick(e, board, config, socket, room, informer) {
	            var _this = this;
	        ...
	        key: 'handleMove',
	        value: function handleMove(e, config) {
	        ...
	        key: 'checkWin',
	        value: function checkWin(socket, result) {
	            var winLine = ['', '', '', ''];
	            var fromRight = Math.min(this.matrix.matrix[this.y].length - this.x - 1, 4);
	            var fromLeft = Math.min(this.x, 4);
	            var fromTop = Math.min(this.y, 4);
	            var fromBottom = Math.min(this.matrix.matrix.length - this.y - 1, 4);
	            for (var i = this.x - fromLeft; i <= this.x + fromRight; i++) {
	                winLine[0] += this.matrix.matrix[this.y][i];
	            }for (var _i = this.y - fromTop; _i <= this.y + fromBottom; _i++) {
	                winLine[1] += this.matrix.matrix[_i][this.x];
	            }for (var _i2 = -Math.min(fromTop, fromLeft); _i2 <= Math.min(fromBottom, fromRight); _i2++) {
	                winLine[2] += this.matrix.matrix[this.y + _i2][this.x + _i2];
	            }for (var _i3 = -Math.min(fromBottom, fromLeft); _i3 <= Math.min(fromTop, fromRight); _i3++) {
	                winLine[3] += this.matrix.matrix[this.y - _i3][this.x + _i3];
	            }for (var _i4 = 0; _i4 < winLine.length; _i4++) {
	                if (winLine[_i4].search('xxxxx') >= 0) {
	                    socket.socket.emit('game:win', 'x');
	                } else if (winLine[_i4].search('ooooo') >= 0) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Settings = exports.Settings = function () {
	    ...
	    _createClass(Settings, [{
	        ...
	        key: 'setStartSettings',
	        value: function setStartSettings(config) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Socket = exports.Socket = function () {
	    function Socket(matrix, game, config) {
	        ...
	        this.socket = window.location.port.length ? (0, _socket2.default)('http://' + window.location.hostname + ":" + window.location.port) : (0, _socket2.default)('http://' + window.location.hostname);
	        this.matrix = matrix;
	        this.game = game;
	        this.config = config;
	        this.who;
	    ...
	    _createClass(Socket, [{
	        ...
	        value: function init() {
	            ...
	            this.socket.on('connect', function () {
	                _this.socket.emit('user-connect', _this.socket.io.engine.id);
	            });

	            this.socket.on('disconnect', function () {
	                _this.socket.emit('user-disconnect', 'DISCONNECTED:' + _this.socket.io.engine.id);
	            });

	            this.socket.on('game:init', function (data) {
	                _this.game.init();

	                if (data.id.substr(2) === _this.socket.id) {
	                    _this.who = data.who === 'x' ? 'o' : 'x';
	                } else {
	                    _this.who = data.who === 'x' ? 'x' : 'o';
	                }
	                console.log(data, _this.game.inGame);
	                _this.rooms = data.rooms;
	                _this.game.inGame = true;
	                if (Object.keys(_this.game.config).length) _this.socket.emit('game:config', {
	                    config: data.config,
	                    matrix: data.matrix,
	                    data: data.room,
	                    rooms: data.rooms,
	        ...
	        key: 'gameWatchers',
	        value: function gameWatchers(render, config) {
	            var _this2 = this;

	            this.model.socket.socket.on('game:start', function (data) {
	                _this2.config = data.config;
	                _this2.view.interface.setConfig();
	                _this2.view.interface.renderGameScreen(data.config);
	                _this2.model.settings.init(data.config);
	                _this2.view.board.initBoard(data.config);
	                _this2.view.board.board.addEventListener('mousemove', function (e) {
	                    return _this2.model.game.handleMove(e, data.config);
	                });

	                _this2.view.board.board.addEventListener('click', function (e) {
	                    if (_this2.model.socket.who === _this2.model.game.who && _this2.model.game.inGame) {
	                        _this2.model.game.handleClick(e, _this2.view.board, data.config, _this2.model.socket, data.room);
	                    }
	                });
	            });
	        }
	        ...
	        key: 'moveWathcers',
	        value: function moveWathcers(config) {
	            var _this3 = this;

	            this.model.socket.socket.on('move', function (data) {
	                _this3.model.game.who = data.who;
	                _this3.model.socket.matrix.matrix = data.matrix;
	                _this3.view.board.renderBoard(data.matrix, data.config);
	            });
	        }
	    }, {
	        key: 'createRoom',
	        ...
	        key: 'move',
	        value: function move(matrix, config, room) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Informer = __webpack_require__(56);

	var _Interface = __webpack_require__(57);
	...
	var View = exports.View = function () {
	    function View(model) {
	        ...
	        this.board = new _Board.Board(this.model);
	        this.informer = new _Informer.Informer(this.model);
	        this.interface = new _Interface.Interface(this.board, this.model);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Board = exports.Board = function () {
	    ...
	    _createClass(Board, [{
	        key: 'initBoard',
	        value: function initBoard(config) {
	        ...
	        key: 'renderBoard',
	        value: function renderBoard(matrix, config) {
	            var ctx = this.ctx;
	        ...
	        key: 'drowBoard',
	        value: function drowBoard(config) {
	            var ctx = this.ctx;
	        ...
	        key: 'renderO',
	        value: function renderO(n, m, config) {
	            var ctx = this.ctx;
	        ...
	        key: 'renderX',
	        value: function renderX(n, m, config) {
	            var ctx = this.ctx;
	            var cell = +config.cellSize;
	            var mCell = m * cell;
	            var nCell = n * cell;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Informer = exports.Informer = function () {
	    function Informer(model) {
	        _classCallCheck(this, Informer);

	        this.model = model;
	    }

	    _createClass(Informer, [{
	        key: 'wait',
	        value: function wait() {
	        ...
	        value: function info() {
	            ...
	            setInterval(function () {
	                document.querySelector('#informer').innerHTML = tpl({
	                    info: {
	                        player: _this.model.socket.who,
	                        who: _this.model.game.who,
	                        text: ''
	                    }
	                });
	            }, 100);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Interface = exports.Interface = function () {
	    function Interface(board, model) {
	    ...
	    _createClass(Interface, [{
	        ...
	        key: 'renderGameScreen',
	        value: function renderGameScreen(config) {
	        ...
	        key: 'renderGameListScreen',
	        value: function renderGameListScreen(data, cb) {
	            var _this = this;

	            var tmpl = _.template(document.querySelector('#list-screen').innerHTML);
	            this.model.socket.getSize();

	            this.model.socket.socket.on('size', function (size) {
	                _this.app.innerHTML = tmpl({
	                    rooms: data.data.rooms,
	                    size: size
	                });
	                _this.button.create = document.querySelector('#create');
	                _this.table = document.querySelector('.js-list-screen-table');
	                cb();
	            });
	        }
	    }, {
	        key: 'renderFinishScreen',
	        value: function renderFinishScreen(data) {
	...
	var Controller = exports.Controller = function () {
	    ...
	    _createClass(Controller, [{
	        ...
	        value: function onInit() {
	            ...
	            this.view.interface.button.create.addEventListener('click', function () {
	                return _this.onStartScreen();
	            });
	            this.view.interface.button.join.addEventListener('click', function () {
	                return _this.onGameListScreen(_this.model.socket.config);
	            });
	        }
	    }, {
	        key: 'watchers',
	        value: function watchers() {
	            ...
	            this.model.socket.socket.on('update', function (data) {
	                _this2.model.socket.informer = _this2.view.informer;
	                var result = [];
	                var rooms = Object.keys(data).filter(function (item) {
	            ...
	            this.model.socket.socket.on('win', function (data) {
	                _this2.view.interface.renderFinishScreen(data);
	                _this2.view.interface.newGameButton.addEventListener('click', function () {
	                    _this2.model.matrix.matrix = _this2.model.matrix.generateMatrix(data.config.size);
	                    _this2.view.interface.renderGameScreen(data.config);
	                    _this2.model.settings.init(data.config);
	                    _this2.view.board.initBoard(data.config);
	                    _this2.model.socket.socket.emit('game:reNew', { win: data.win, config: data.config, room: data.room, who: _this2.model.socket.who });
	                    _this2.view.board.board.addEventListener('mousemove', function (e) {
	                        return _this2.model.game.handleMove(e, data.config);
	                    });
	                    _this2.view.board.board.addEventListener('click', function (e) {
	                        if (_this2.model.socket.who === _this2.model.game.who && _this2.model.game.inGame) {
	                            _this2.model.game.handleClick(e, _this2.view.board, data.config, _this2.model.socket, _this2.room);
	                        }
	                    });
	                });
	            });
	        ...
	        key: 'onGameListScreen',
	        value: function onGameListScreen(config) {
	            var _this3 = this;
	            ...
	            this.view.interface.renderGameListScreen({
	                ...
	                _this3.view.interface.table.addEventListener('click', function (e) {
	                    if (!e.target.parentNode.classList.contains('js-list-screen-row')) return;
	                    _this3.room = e.target.parentNode.dataset.room;

	                    _this3.model.socket.gameWatchers.call(_this3);
	                    _this3.model.socket.joinGame(e.target.parentNode.dataset.room);
	                });
	                _this3.view.interface.button.create.addEventListener('click', function () {
	                    return _this3.onStartScreen();
	                });
	            });
	        }
	    }, {
	        key: 'onStartScreen',
	        value: function onStartScreen() {
	            var _this4 = this;

	            this.view.interface.renderSettingsScreen();
	            this.model.game.setConfig();
	            this.view.interface.form.addEventListener('submit', function (e) {
	                return _this4.onSettingsScreen(e);
	            });
	        }
	    }, {
	        key: 'onSettingsScreen',
	        value: function onSettingsScreen(e) {
	            var _this5 = this;
	            ...
	            this.view.board.board.addEventListener('mousemove', function (e) {
	                return _this5.model.game.handleMove(e, _this5.model.game.config);
	            });
	            this.view.board.board.addEventListener('click', function (e) {

	                if (_this5.model.socket.who === _this5.model.game.who && _this5.model.game.inGame) {
	                    _this5.model.game.handleClick(e, _this5.view.board, _this5.model.game.config, _this5.model.socket, _this5.room);
	                }
	            });
	        }
	    }]);
